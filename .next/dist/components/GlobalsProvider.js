...
var _frenchLocale = require('./assets/french-locale');

var _frenchLocale2 = _interopRequireDefault(_frenchLocale);

var _WebNotePointerPointer = require('metis-shared/dist/components/views/dynamic/WebNotePointerPointer');

var _WebNotePointerPointer2 = _interopRequireDefault(_WebNotePointerPointer);

var _WebNoteContentPointer = require('metis-shared/dist/components/views/dynamic/WebNoteContentPointer');
...
var GlobalsProvider = function (_Component) {
  ...
  function GlobalsProvider() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = GlobalsProvider.__proto__ || (0, _getPrototypeOf2.default)(GlobalsProvider)).call.apply(_ref, [this].concat(args))), _this), _this.getChildContext = function () {
      return {
        ...
        citationLocale: _frenchLocale2.default,
        renderingMode: 'web',
  ...
  (0, _createClass3.default)(GlobalsProvider, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('section', { className: 'GlobalsProvider' }, children,

      // placeholder loading gif view
      // for serverside/no-js rendering (see comments above)
      !inBrowser && _react2.default.createElement('section', {
        style: {
          width: '100%',
          height: '100%',
          position: 'fixed',
